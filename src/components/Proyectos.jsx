  ...
  const proyectos = [
    {
      ...
      descripcion: "Flujos de trabajo automatizados para empresas",
      tags: ["Python", "Docker", "Redis"]
    },
    {
      nombre: "E-commerce Platform",
      descripcion: "Plataforma de ventas con pago integrado",
      tags: ["React", "Node.js", "MongoDB"]
    },
    {
      nombre: "Red Corporativa",
      descripcion: "Infraestructura de red segura y escalable",
      tags: ["Cisco", "AWS", "VPN"]
    }
  ];
